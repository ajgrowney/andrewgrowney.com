...
FT_2021_SRC = "/Users/andrewgrowney/Data/kaggle/marchmadness-2021/Training"
FT_DEST_ROOT = "/Users/andrewgrowney/Code/React/andrewgrowney.com/src/Data/mm/features"
FEATURE_SETS = [
    ('2021', 'all_models.json', [(y,os.path.join(FT_2021_SRC, f'features_{y}.csv')) for y in range(2003,2022)])
]
